...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        google_save_button_exists = exists(google_save_button_pattern, Settings.FIREFOX_TIMEOUT*3)  # SITE_LOAD_TIMEOUT
        ...
        google_images_page_opened = exists(google_images_page_mark_pattern, Settings.FIREFOX_TIMEOUT*3)
        # SITE_LOAD_TIMEOUT
        ...
        show_more_results_button_destinated = scroll_until_pattern_found(show_more_results_button_pattern,
                                                                         Mouse.scroll, (-mouse_wheel_steps,), 100)
