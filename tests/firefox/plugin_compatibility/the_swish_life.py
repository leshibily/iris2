...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        window_opened = exists(the_swish_life_tab_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT * 3)
        ...
        fashion_page_opened = exists(fashion_page_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT * 3)
        assert fashion_page_opened is True, 'The "Fashion" page is opened'

        click(the_home_button_pattern)

        home_page_label = exists(fashion_page_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT * 3)
