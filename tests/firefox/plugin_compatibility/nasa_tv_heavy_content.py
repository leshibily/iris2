...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        change_preference('media.autoplay.default', '0')  # Not working as expected
        ...
        nasa_tv_page_loaded = exists(nasa_tv_page_pattern, Settings.DEFAULT_HEAVY_SITE_LOAD_TIMEOUT)
        ...
        video_playing = exists(speaker_icon_pattern, Settings.DEFAULT_SITE_LOAD_TIMEOUT, tabs_region)
        ...
        page_scrolled = exists(page_bottom_marker_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        speaker_icon_appear = exists(speaker_icon_pattern, Settings.DEFAULT_SITE_LOAD_TIMEOUT, tabs_region)
