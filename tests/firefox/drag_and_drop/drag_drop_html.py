...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        if not OSHelper.is_mac():
            ...
            mouse.drag_and_drop(new_tab_location, start_position)
        ...
        paste('window.resizeTo({0}, {1})'.format(Screen.SCREEN_WIDTH // 2, Screen.SCREEN_HEIGHT * 9 // 10))
        type(Key.ENTER)
        close_tab()
        ...
        mouse.drag_and_drop(opened_tab_location, new_window_drop_location)
        ...
        mouse.drag_and_drop(paragraph, selection_end)
        ...
        mouse.drag_and_drop(paragraph, drop_html_position)
        ...
        mouse.drag_and_drop(url_location, drop_html_position)
