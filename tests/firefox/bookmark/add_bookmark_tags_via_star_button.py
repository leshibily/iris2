...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        mozilla_page_assert = exists(LocalWeb.MOZILLA_LOGO, Settings.DEFAULT_FIREFOX_TIMEOUT)
        assert mozilla_page_assert is True, 'Mozilla page loaded successfully.'

        try:
            wait(bookmark_button_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        page_bookmarked_assert = exists(Bookmarks.StarDialog.NEW_BOOKMARK, Settings.DEFAULT_FIREFOX_TIMEOUT)
        assert page_bookmarked_assert is True, 'The page was successfully bookmarked via star button.'

        try:
            wait(tags_field, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        try:
            wait(done, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        tagged_bookmark_assert = exists(moz_tagged_bookmark, Settings.DEFAULT_FIREFOX_TIMEOUT)
