...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        bookmarks_menu_library_assert = exists(library_bookmarks_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        library_bookmark_assert = exists(moz_library_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
