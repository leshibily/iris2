...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        try:
            wait(moz_bookmark_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        option_assert = exists(properties_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        assert option_assert is True, 'Properties option is present on the page.'

        click(properties_pattern)

        properties_window_assert = exists(save_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
        ...
        tagged_bookmark_assert = exists(moz_bookmark_pattern, Settings.DEFAULT_FIREFOX_TIMEOUT)
